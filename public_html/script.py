...
def data_by_id(forward, midfield, defender, goalkeeper):
     ...
     for id in forward:
             for i in json_decode['elements']:
                     if i['id'] == id:
                             dforward.append((id, i['first_name'].encode('ascii','ignore') + " " + i['second_name'].encode('ascii','ignore'), i['team_code']))
     for id in midfield:
             for i in json_decode['elements']:
                     if i['id'] == id:
                             dmidfield.append((id, i['first_name'].encode('ascii','ignore') + " " + i['second_name'].encode('ascii','ignore'), i['team_code']))
     for id in defender:
             for i in json_decode['elements']:
                     if i['id'] == id:
                             ddefender.append((id, i['first_name'].encode('ascii','ignore') + " " + i['second_name'].encode('ascii','ignore'), i['team_code']))
     for id in goalkeeper:
             for i in json_decode['elements']:
                     if i['id'] == id:
                             dgoalkeeper.append((id, i['first_name'].encode('ascii','ignore') + " " + i['second_name'].encode('ascii','ignore'), i['team_code']))
...
gkp  = literal_eval(argv[3]);
mid  = literal_eval(argv[4]);
